  ...
  return (
    <div className="min-h-screen bg-[#0b0b0d] pt-36 pb-24 text-gray-100 flex items-center justify-center">
      <div className="max-w-md w-full mx-auto px-4 text-center space-y-6">
        <div className="w-20 h-20 rounded-full bg-[#161622] border border-[#2a2a38] mx-auto flex items-center justify-center text-[#2dd4bf]">
          <Watch size={36} />
        </div>
        <span className="text-xs uppercase tracking-[0.3em] text-[#2dd4bf] font-semibold block">
